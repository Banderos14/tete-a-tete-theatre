...
export const FR: T = {
  ...
  booking: {
    ...
    successOnSite: 'Votre réservation est créée. Votre QR code se trouve dans votre espace personnel, rubrique «\u00a0Mes billets\u00a0». Présentez-le au personnel du théâtre à l\'entrée du spectacle. Le paiement se fait sur place.',
    successTransfer: 'Votre réservation est créée et en attente de paiement. Les coordonnées bancaires ont été envoyées par e-mail — le virement doit être effectué sous 24 heures. Votre réservation sera confirmée après validation du paiement. Le QR code est disponible dans votre espace personnel, rubrique «\u00a0Mes billets\u00a0» ; pour accéder au spectacle, le billet doit être payé.',
