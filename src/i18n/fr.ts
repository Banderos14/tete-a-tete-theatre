...
export const FR: T = {
  ...
  booking: {
    ...
    copyRawIban:          'Sans espaces',
    ibanNoSpacesHint:     'Certaines banques acceptent l\'IBAN uniquement sans espaces.',
    ibanNoSpacesLabel:    'IBAN sans espaces',
    bankIbanSpacesWarning:'Si votre banque n\'accepte pas l\'IBAN avec espaces, collez l\'IBAN sans espaces — il s\'agit du même compte.',
  },
  admin: {
