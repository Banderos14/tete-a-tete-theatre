...
export const RU: T = {
  ...
  booking: {
    ...
    copyRawIban:          'Без пробелов',
    ibanNoSpacesHint:     'Некоторые банки принимают IBAN только без пробелов.',
    ibanNoSpacesLabel:    'IBAN без пробелов',
    bankIbanSpacesWarning:'Если ваш банк не принимает IBAN с пробелами, вставьте IBAN без пробелов — это тот же самый счёт.',
  },
  admin: {
