...
export const RU: T = {
  ...
  booking: {
    ...
    successOnSite: 'Бронирование создано. Ваш QR-код находится в личном кабинете, в разделе «Мои билеты». Покажите QR-код сотруднику театра при входе на спектакль. Оплата производится на месте.',
    successTransfer: 'Бронирование создано и ожидает оплаты. Реквизиты отправлены на вашу почту — перевод нужно выполнить в течение 24 часов. После подтверждения оплаты бронь станет подтверждённой. QR-код доступен в личном кабинете, в разделе «Мои билеты»; для прохода на спектакль билет должен быть оплачен.',
