...
// Набор тем уже, чем короче афиша, поэтому число копий считается от замера:
//   3 спектакля × ~340px = ~1020px → desktop 1920px укладывается в MIN_COPIES;
//   2 спектакля × ~340px = ~680px  → нужно больше, увеличим динамически.
const MIN_COPIES = 5;
