...
## Шаг 2. Добавь блок ниже в AGENTS.md в корне проекта (один раз)

Если файла AGENTS.md нет — создай. Codex читает его автоматически
...
Если что-то не так — не переписывай промпт, а отвечай Codex точечной правкой
